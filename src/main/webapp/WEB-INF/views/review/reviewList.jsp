					...
					<c:forEach var="review" items="${reviewList}" varStatus="reviewNum">
						<div class="col-md-5" style="border-style:solid; 
							...
							<h5><strong><a href="${contextPath}/review/viewReview.do?reviewNO=${review.reviewNO}">
								<p style="font-size:30px">${review.name}<p></a></strong>
							</h5>
							<div style="text-align:left">
								<p style="font-size:15px; text-align:left;">${review.zipcode}<br>
								<p style="font-size:15px; text-align:left;">${review.address}<br>
								<p style="color:gray;font-size:12px; text-align:left;">이용 후기 평점 : ${review.point}</p>
								<p style="font-size:15px; text-align:left;">
									<img src="${contextPath}/resources/reviewImage/like.png" style="width:14px; height:15px">${review.love}<br>
								</p>
								<p style="font-size:15px; text-align:left;">
									<img src="${contextPath}/resources/reviewImage/dislike.png" style="width:12px; height:12px">${review.dislove}<br>
								</p>
								<p style="color:gray;font-size:12px; text-align:left;">
									&nbsp;&nbsp;후기 작성일: ${review.writeDate}
								</p>	
								<p style="color:gray;font-size:13px; text-align:left;">
									<img src="${contextPath}/resources/reviewImage/PeopleIcon.jpeg"
										style="width:20px; height:20px;">
									<a href="${contextPath}/General/mypage.do">${review.id}</a>
								</p>
							</div>
							<div>
								<c:if test="${isLogOn == true  && member!= null && member.id==review.id}">
